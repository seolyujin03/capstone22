...
<ol>
<li> 메인페이지 마무리 작업 </li>
<ul><li>메인의 영어 부분 수정</li>
<li>중단부분 의류 인터뷰 내용으로 교체</li>
</ul>
<li>상세페이지에 접근하기 전의 상품이미지 선정,배치 </li></ol>
...
작업물의 분위기를 맞추기 위해 마치 위시리스트 작성하듯한 느낌을 주기위해 상품 사진에 쓰일 꾸밈 포인트로 뜯긴 테이프모양의 아이템을 만듬
