...
- 메인페이지에 들어갈 제품 확정과 디자인 담당 세분화
1. 메인페이지에는 립,페이스,아이 대표제품을 그림으로 직접 그려서 링크를 걸어서 상세페이지로 이동할수 있도록 디자인을 구상함
2. 기존의 디자인은 고급진 분위기였으나 회의를 통해 귀여운 느낌을 살려서 마우스 포인트와 메인페이지의 이미지를 직접 그리기로 함  
<br>
- 상세페이지에 대한 세밀한 조사 및 구상
 1. 상세 페이지에는 상품 각자의 기준을 두고 그에 맞추어 디자인 하기로 함
 2. 각 상품의 유명한 사이트를 조사하며 어떤 느낌으로 사진을 찍고 어떤 방식으로 글을 적어서 전달하는지 확인 후 참고
 3. 선크림 - 닥터지참고 선크림의 기능, 판매량, 후기 등등을 작성 / 아이섀도우 - 색상이 잘 나타나 있는 사진으로 여러 색상 촬영 / 립스틱 - 색상 위주 사진과 지속력,묻어남 등 제품 상태를 위주로 작성
